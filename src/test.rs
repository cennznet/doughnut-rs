...
fn versioned_enum_v0_sr25519_verification() {
        let encoded: Vec<u8> = vec![
            ...
            0x00, 0x00, 0x03,
            // issuer
            0x82, 0x69, 0x6b, 0x88, 0xc8, 0x39, 0xa4, 0xd9, 0x53, 0xb4, 0x4d, 0x66, 0x15, 0x6e, 0x64, 0x17,
            0x71, 0xe7, 0xe8, 0x1b, 0x43, 0xb5, 0x82, 0xd2, 0xae, 0x4b, 0x48, 0xcd, 0x20, 0xc7, 0xd0, 0x6d,
            // holder
            ...
            0x00, 0x4b, 0x20, 0x00,
            // Domain
            0x00, 0x73, 0x6f, 0x6d, 0x65, 0x74, 0x68, 0x69, 0x6e, 0x67, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x73, 0x6f, 0x6d, 0x65, 0x74, 0x68, 0x69, 0x6e, 0x67, 0x45, 0x6c, 0x73, 0x65, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
            // Signature
            0xf8, 0x04, 0x52, 0xd8, 0x5b, 0xae, 0x11, 0x1d, 0x0f, 0x54, 0x91, 0x43, 0x39, 0xbb, 0x49, 0x6e,
            0x23, 0x7e, 0x70, 0xfb, 0x43, 0xae, 0xd2, 0x9b, 0x2a, 0xe6, 0xbd, 0xec, 0x62, 0xca, 0x33, 0x0a,
            0xe2, 0xf3, 0xa3, 0xe9, 0x4d, 0x9e, 0xc9, 0x83, 0x52, 0x7e, 0x8c, 0xe7, 0x71, 0xd3, 0xe6, 0x53,
            0xe7, 0xe1, 0xe2, 0xb3, 0x40, 0x36, 0x07, 0x73, 0x06, 0xf1, 0x8a, 0x59, 0xc0, 0x9f, 0x45, 0x82];
    ...
    assert_eq!(
        d.domains[0],
        ("something".to_string(), vec![0])
    );
    assert_eq!(
        d.domains[1],
        ("somethingElse".to_string(), vec![0])
    );
